...
\definefont[smallfont][Regular at \readingsize]
\definefont[smallfontbold][RegularBold at \readingsize]
...
\def\dolinedesc[#1][#2][#3][#4]{{%
  ...
  \par
  \smallfont
  \getvariable{line}{description} --
  {\smallfontbold \getvariable{line}{reading}} --
  \getvariable{line}{translation}
  \par
  \leavevmode
  \bigfont
